PATH=$HOME/.config/tmux/plugins/t-smart-tmux-session-manager/bin:$HOME/bin:/home/hqkhan/.fzf/bin:/opt/homebrew/bin:/usr/local/bin:/usr/local/sbin:/bin:/sbin:/usr/bin:/usr/sbin:/opt/local/bin:$HOME/.local/bin:$HOME/.cargo/bin:/home/linuxbrew/.linuxbrew/bin:/usr/local/go/bin
